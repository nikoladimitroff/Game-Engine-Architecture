...
<!-- .slide: data-background="url(resources/01.intro/ac_origins_poster.jpg)" data-background-repeat="no-repeat" data-background-size="cover" data-background-position="center center" class="high-contrast-text" -->
### Ubisoft Sofia
...
* 2 tests * 20% = 40%
    * 2 bonuses * 5% = 10%
* 1 homework/mini cource project * 20% = 20%
...
![Market size](resources/01.intro/games_vs_entertainment.jpeg.png)
...
* Can't break in the AAA sector - Previously there were problems with rendering quality, extensibility, openness, tools seem lacking.
...
Quote from [Kotaku Article](https://kotaku.com/the-story-behind-mass-effect-andromedas-troubled-five-1795886428)
...
* VS 2017/2019 Community Edition
* Git
