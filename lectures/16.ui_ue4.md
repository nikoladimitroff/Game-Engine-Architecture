...
* <!-- .element class="fragment" data-fragment-index="0" --> Special purpose blueprints
* <!-- .element class="fragment" data-fragment-index="1" --> Computes the final pose of the skeleton
...
* <!-- .element class="fragment" data-fragment-index="0" --> Enables animations to play well with collision
...
* <!-- .element class="fragment" data-fragment-index="0" --> Animation based on physics simulation. Can be blent with keyframed animation.
...
<!-- .element class="fragment" data-fragment-index="0" --> ![Sealiest thing](resources/16.ui_ue4/sealiest_thing_meme.jpg)
...
`STopDownRPGLoginScreep::ConstructInitialLoginScreen`
...
* `SComponentWidget` - a *composition* of widgets (`STopDownRPGWidget`)
