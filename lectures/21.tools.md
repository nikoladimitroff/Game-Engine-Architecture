...
Path finding algorithm<!-- .element class="fragment" -->
...
A Map where different AI algorithms can access data. <!-- .element class="fragment" -->
...
* Tree of decision(if/else) which lead to leaf node with an action <!-- .element class="fragment" -->
* Graph with states representing actions, and transition between states representing events. <!-- .element class="fragment" -->
