...
Now when one allocates the heap he must manage the memory inside. He must answer this questions
Creating resources inside, freeing resources
How about multiple threads allocations?
When I free something, does gpu use it?
...
commandList->OMSetRenderTarget( gpuPointer )
...
Descriptors are organized in a heap
By types
