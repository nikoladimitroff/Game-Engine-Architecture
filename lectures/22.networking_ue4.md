...
Replicates
    ...
    * Method overview (PreReplication, ReplicateSubojbects, OnSubobject...Replicated)
----
RPC
----
Relevancy
...
Travelling
---
Prediction in Character/Projectile MovementComponent
---
Network in Engine/Net
---
Network* & Online* & HTTP modules
---
Network replay
...
1. If accepted, the server will then call AGameMode::Login
    * This function creates the PlayerController,
    which will then be replicated to the newly connected client.
    Once received, this PlayerController will replace the clients temporary
    PlayerController that was used as a placeholder during the connection process.
