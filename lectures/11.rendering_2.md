...
* Hardware with ray tracing capabilities is coming to the market
...
* <span style="color: green">Sampler ( this is a special hardware that performs sampling )
 ...
 * fence->SetEventOnCompletion(fence, 100); WaitForSingleObject(fence, INFINITE);
...
--- VERTICAL SLIDE ---
![Pipeline](resources/10.rendering/extraction-frame-schematic.png)   <!-- .element class="constrain-image" -->
...
--- VERTICAL SLIDE ---
![Pipeline](resources/10.rendering/extraction-game-data-extraction.png)   <!-- .element class="constrain-image" -->
--- VERTICAL SLIDE ---
...
```
--- VERTICAL SLIDE ---
![Pipeline](resources/10.rendering/render-graph-resource-culling.png)   <!-- .element class="constrain-image" -->
...
--- VERTICAL SLIDE ---
![Pipeline](resources/10.rendering/render-graph-passes.png)   <!-- .element class="constrain-image" -->

--- VERTICAL SLIDE ---
![Pipeline](resources/10.rendering/render-graph-dx12-pc.png)   <!-- .element class="constrain-image" -->

--- VERTICAL SLIDE ---
![Pipeline](resources/10.rendering/render-graph-trasient-xbox-one.png)   <!-- .element class="constrain-image" -->
